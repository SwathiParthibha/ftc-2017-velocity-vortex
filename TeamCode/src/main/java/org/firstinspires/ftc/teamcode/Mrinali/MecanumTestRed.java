...
@Autonomous(name = "Mecanum Test Red", group = "Mecanum")
public class MecanumTestRed extends FtcOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (!isStarted()) {
            ...
            telemetry.addData("Angle from driivebase", auto.driveBase.getHeading());
