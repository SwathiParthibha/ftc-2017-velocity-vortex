...
public final class Constants {
    ...
    public static int REQUESTED_ETPS = 125000;//88704;//83160;//77616;//35150;//1855;//1590;//1750 good for close shots
    public static final int DELTA_TIME = 50;
    public static final int ONE_SECOND = 1000;

    public static double DEFAULT_POWER = 0.73;//0.45;//0.455;//0.42
